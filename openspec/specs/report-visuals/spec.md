# report-visuals Specification

## Purpose
Round results that show up visually on GitHub: standalone, deterministic SVG charts in `rounds/<round>/charts/` linked from RESULTS.md, mermaid flowcharts of the round and its pipelines, and the same charts inlined in report.html.
## Requirements
